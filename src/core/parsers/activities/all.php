<div class="row shadow-sm p-3 mb-5 bg-white rounded" style="border-radius: 15px !important;">
    ...
    if (HOST_IS_LIVE) {
        $cnt_sql        = "SELECT * FROM notifications WHERE notification_status = 1";
        $cnt_dta        = [];
                    ...
                    <?php foreach ($nwsf_qry as $key => $association) : ?>
                        ...
                        <tr>
                            ...
                            <td style="white-space: nowrap; width: 1">
                                <a class="me-3 float-end" type="button" onclick="requestModal(post_modal[15], post_modal[15], {'usr':<?= $association['notification_id'] ?>, 'msg':'<?= $notif_msg ?>' })"> <i class="fa-solid fa-eye me-1"></i> View </a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                <?php endif; ?>
