<div class="row shadow-sm px-0 mb-3 bg-white rounded " style="border-radius: 15px !important;">
    ...
    if (HOST_IS_LIVE) {
        $cnt_sql        = "SELECT * FROM users WHERE user_type != 'guest' AND user_status = 1";
        $cnt_dta        = [];
    ...
    <div class="col-12 pt-4 px-3">
        <a class="btn btn-dark border-radius-lg" type="button" onclick="requestModal(post_modal[16], post_modal[16], {'graph':true})"> 
