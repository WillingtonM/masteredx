<?php if (isset($_SESSION['user_id'])) : ?>
    <div class="w-100 pt-3/ px-1">
        <button type="button" class="btn btn-dark border-radius-lg" onclick="requestModal(post_modal[1], 'mediaModal', {'type':'appearance'})"> <span class=""> <i class="fas fa-media-plus me-2"></i> Upload Media Appearance</span> </button>
    </div>
<?php endif; ?>
<div class="col-12">
    <div class="row">
