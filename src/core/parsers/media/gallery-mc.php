<?php if (isset($_SESSION['user_id'])) : ?>
    <div class="col-12 pt-3 px-1">
        <button type="button" class="btn btn-dark border-radius-lg" onclick="requestModal(post_modal[4], 'galleryModal', {'type':'gallery-mc'})"> <span class=""> <i class="fas fa-media-plus me-2"></i> Upload Gallery </span> </button>
    </div>
<?php endif; ?>
