...
<div class="row">
    ...
    <div class="col-12 mt-4">
        <?php if (isset($career) && !empty($career)) : ?>
            <a type="button" class="btn btn-danger btn-sm shadow-none text-white float-end border-radius-lg" onclick="postCheck('error_pop', {'career_remove':true,'career':<?= $career['career_id'] ?>});"> Remove</a>
        <?php endif; ?>
        <button class="btn btn-secondary btn-sm border-radius-lg shadow-none" onclick="postCheck('error_pop', $('#careerForm').serialize(), 0, true)"> <?= ((isset($_POST['career']) && $_POST['career'] != '') ? 'Edit' : 'Add') ?> Career </button>
    </div>
</div>