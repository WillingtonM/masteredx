        ...
        <?php if (!empty($practice_tasks)): ?>
            ...
            <?php foreach ($practice_tasks as $key => $practice) : ?>
                ...
                <tr>
                    ...
                    <td>
                        <a class="float-end me-3 cursor-pointer" type="button" onclick="requestModal(post_modal[24], post_modal[24], {'practice_task':<?= $practice['practice_task_id'] ?>})"> <i class="fa-solid fa-pen-to-square me-1"></i> Edit </a>
                    </td>
                </tr>
            <?php endforeach; ?>
        <?php endif; ?>
