  ...
  <div class="row">
    ...
    <div id="" class="media_div col-12 shadow bg-white" style="border-radius: 25px;">
      ...
      <div class="col-12 px-3">
        <button type="button" class="btn btn-sm btn-secondary shadow-none border-radius-lg me-2" onclick="modal_post()">Save changes</button>
        <button type="button" class="btn btn-sm btn-info shadow-none border-radius-lg me-2" onclick="requestModal( post_modal[7], post_modal[7], $('#article_form').serialize() + '&article_content=' + encodeURIComponent(tinyMCE.get('mytextarea').getContent()), 1); ">View Article</button>
        ...
        <?php if (isset($article_id) && !empty($article_id)) : ?>
          <button type="button" class="btn btn-sm btn-danger float-end shadow-none border-radius-lg me-2" onclick="postCheck('null',{'article_id': <?= $article_id ?>, 'article_remove':true, 'article_type':'<?= $req_res['article_type'] ?>'})">Remove article</button>
        <?php endif; ?>
      </div>
      <br>
