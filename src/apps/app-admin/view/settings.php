    ...
    <div class="row shadow p-3 mb-5 bg-white border-radius-xl/" style="border-radius: 15px;">
        ...
        <form id="header_form" class="col-12 mb-3" action="">
            ...
            <div class="col-12 mb-3 px-3">
                ...
                <button type="button" class="btn btn-sm btn-secondary px-3 shadow-none" style="border-radius: 11px;" onclick="function_tinytext_forms('header_form', 'textarea_header')">Save Article email header text</button>
            </div>
        </form>
        ...
        <form id="footer_form" class="col-12 mb-3" action="">
            ...
            <div class="col-12 mb-3 px-3">
                <div id="error_pop" class="error_pop mb-3"></div>
                <button type="button" class="btn btn-sm btn-secondary px-3 shadow-none" style="border-radius: 11px;" onclick="function_tinytext_forms('footer_form', 'mytextarea')">Save Article email footer tex</button>
            </div>
        </form>
    </div>
