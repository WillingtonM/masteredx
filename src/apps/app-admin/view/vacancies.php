                                    ...
                                    <?php foreach ($careers_data as $career) : ?>
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle">
                                                <a href="javascript:;" class="text-secondary font-weight-bold text-xs" onclick="requestModal(post_modal[16], post_modal[16], {'career':<?= $career['application_id'] ?>, 'type':'vacancy'})">
                                                    Edit
                                                </a>
                                            </td>
                                        </tr>
