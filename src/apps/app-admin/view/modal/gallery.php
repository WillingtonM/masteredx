...
<div class="row">
	...
	<div class="col-12 mt-4">
		<?php if (isset($media_res) && !empty($media_res)) : ?>
			<a type="button" class="btn btn-danger btn-sm shadow-none text-white float-end border-radius-lg" onclick="postCheck('error_pop', {'media_remove':true,'media_id':<?= $media_res['media_id'] ?>});"> Remove</a>
		<?php endif; ?>
		<button class="btn btn-secondary btn-sm border-radius-lg shadow-none" onclick="media_post()"> <?= ((isset($_POST['media_id']) && $_POST['media_id'] != '') ? 'Edit' : 'Add') ?> Gallery</button>
	</div>
</div>
