...
<div class="row">
  <div class="col-12 mt-4">
    ...
    <?php endif; ?>
    <button type="button" class="btn btn-sm btn-secondary shadow-none border-radiusl-lg" onclick="postCheck('error_pop',  $('#media_form').serialize(), 0, true)">Save changes</button>
  </div>
</div>
