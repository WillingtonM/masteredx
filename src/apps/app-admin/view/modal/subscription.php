...
<div class="row">
	<div class="col-12">
		<h5 class="modal-title px-3"><?= ((isset($_POST['subscrb_id']) && $_POST['subscrb_id'] != '') ? 'Subscription | <i class="text-warning">' . $user['subscription_name'] . $user['subscription_last_name'] . '</i>' : 'Add Subscriber') ?></h5>
	</div>
