...
<div class="row">
	<div class="col-12">
		<button class="btn btn-secondary shadow-none btn-sm" onclick="shift_upld_file ('fileModal')"><i class="fa fa-file-upload me-2"></i> <?= ((isset($_POST['media_id']) && $_POST['media_id'] != '') ? 'Edit' : 'Add') ?> Document</button>
	</div>
</div>
