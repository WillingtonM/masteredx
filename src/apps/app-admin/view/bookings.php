        ...
        <div class="col-12">
            <div class="tab-content" id="notif_tab">
                ...
                <?php foreach ($admin_booking as $key => $tabs) : ?>
                    ...
                    <?php $bookings = (($key == 'processed') ? $processed_events : (($key == 'orders') ? get_orders() : get_events())) ?>
                                            ...
                                            <table class="table align-items-center mb-0">
                                                <thead>
                                                    <tr class="bg-light">
                                                        ...
                                                        <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7"> <?= ($key == 'orders') ? 'Track Code': 'Event Type' ?> </th>
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php if (is_array($bookings) || is_object($bookings)) : ?>
                                                        ...
                                                        <?php foreach ($bookings as $value) : ?>
                                                            ...
                                                            <?php $event_text = ($key == 'orders') ? $value['order_track_code'] : $booking_types[$value['event_type']]['text'] ?>
                                                            <?php $date = ($key == 'orders') ? $value["order_date"] : $value['event_host_date'] ?>
                                                            <?php $mode = ($key == 'orders') ? 18: 17 ?>
