    <!-- Modal -->
    <div class="modal fade" id="users" tabindex="-1" role="dialog" aria-labelledby="details-1" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close" onclick="closeModalByID('users');">
                ...
                <div class="modal-footer">
                    <div class="row/">
                        <div class="col-md-4/ pull pull-right">
                            ...
                            <button class="btn btn-warning btn-sm" onclick="modal_user_post();"> <?= (($usr_arr != null) ? 'Edit' : 'Add') ?> User</button>
                        </div>
                    </div>
                </div>
            </div>
        ...
        jQuery(function($) {
            ...
            $('#post_image').on('change', function(e) {
                ...
                if ($('#post_image').val()) {
                    ...
                    // postFile('account_message', 'post_image', file_data, 2);
