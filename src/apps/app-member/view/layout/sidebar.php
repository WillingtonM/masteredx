        ...
        <div class="col py-0 px-3">
            <div class="col shadow border-radius-md text-center p-1">
                <a href="./" class="border-radius-md/">
                    <img src="<?= PROJECT_LOGO ?>" class="navbar-brand-img/ h-150/ border-radius-md" alt="main_logo" style="width: 70px; height: 70px !important; border-radius: 50%; border: 3px solid #ddd; padding: 1px;">
                </a>
            </div>
        </div>
