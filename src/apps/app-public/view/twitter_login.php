<div class="container pt-10 min-vh-100">
    ...
    <div class="row text-center shadow bg-white p-3" style="border-radius: 25px;">
        ...
        <?php if (!$twt_data['success'] && !empty($twt_data['data'])) : ?>
            ...
            <div class="col-12">
                <a type="button" id="social_login" class="col-12 btn btn-info btn-sm" style="border-radius: 12px; font-weight: bolder;"> <i class="fab fa-twitter"></i> &nbsp; Login using Twitter </a>
            </div>
        <?php endif; ?>
