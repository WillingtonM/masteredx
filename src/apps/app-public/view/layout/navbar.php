  ...
  <div class="container position-sticky z-index-sticky top-0 p-0 m-0/">
    <div class="row">
      <div class="col-12 p-0 m-0">
        <!-- Navbar -->
        <nav id="navbar" class="navbar navbar-expand-lg blur blur-rounded/ top-0 z-index-3 shadow position-absolute my-3 py-2 start-0 end-0 mx-4 position-relative border/" style="border-radius: 18px; height: 60px">
          <div class="container-fluid position-relative/">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navigation">
              <ul class="navbar-nav mx-auto/ justify-content-end">
                ...
                <li class="nav-item">
                  <a class="nav-link nav_text def_text <?= ((isset($page) && $page == "tutors") ? 'active nav_text_left' : '') ?>" href="tutors"><i class="fa-solid fa-chalkboard-user me-1"></i> Tutors</a>
                </li>
                <!-- <li class="nav-item">
                  <a class="nav-link nav_text def_text <?= ((isset($page) && $page == "services") ? 'active nav_text_left' : '') ?>" href="services"><i class="fa-solid fa-briefcase me-1"></i> Services</a>
                </li> -->
              ...
              <ul class="navbar-nav d-lg-block d-none">
                <li class="nav-item">
                  <a type="button" class="btn btn-sm mb-0 border-radius-lg bg-gradient-dark/ btn-dark" onclick="requestModal(post_modal[9], post_modal[9], {})"> Enquiry </a>
                </li>
              </ul>
