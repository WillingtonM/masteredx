...
// query gallery media
$rgst_sql     = "SELECT * FROM media WHERE media_status = 1 AND media_type = ? AND media_file_type = ? ORDER BY media_publish_date DESC LIMIT $sql_pg_strt, $intval";
$rgst_dta     = [$key, $file_type];
